...
tail_cmd.add_argument('-f', '--filters', help="logfile prefix filter [default 'warn,error,fatal,customerror,customfatal']", default="warn,error,fatal,customerror,customfatal,api-deprecation")
